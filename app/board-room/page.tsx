    ...
    <div className="bg-paper text-charcoal">
      ...
      <section className="pb-24 md:pb-32">
        <div className="container-x">
          <Gallery photos={[p[1], p[2], p[3]]} tone="light" />
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          <ul className="mt-14 grid gap-px bg-charcoal/15 md:grid-cols-3">
            {[
              ...
              <li key={x.t} className="bg-ivory py-8 md:px-8 md:first:pl-0" data-reveal>
                <h3 className="h3">{x.t}</h3>
                <p className="mt-2 text-muted">{x.d}</p>
                <Link href={x.h} className="link-arrow mt-6 text-charcoal">
      ...
      <section id="enquire" className="scroll-mt-20 bg-charcoal py-24 text-ivory md:py-32">
        <div className="container-x grid gap-14 md:grid-cols-12">
          <div className="md:col-span-4" data-reveal>
            ...
            <h2 className="h2 mt-4">Book the Board Room.</h2>
