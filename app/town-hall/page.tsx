...
export const metadata: Metadata = {
  ...
  description:
    "Town Hall at Hotel New Town by Chettungal, Angamaly: a banquet hall for up to 120 guests with a stage, podium and buffet space. Weddings, receptions, conferences and family occasions.",
  ...
  return (
    <div className="bg-paper text-charcoal">
      <PageHero image={p[0].src} alt={p[0].alt}>
        <Eyebrow className="text-brass-light">Banquet hall · Hotel New Town</Eyebrow>
      ...
      <section className="py-24 md:py-36">
        <div className="container-x grid gap-16 md:grid-cols-12">
          ...
          <div className="md:col-span-6 md:col-start-7" data-reveal>
            <h2 className="h2">The hotel&apos;s largest room.</h2>
      ...
      <section id="enquire" className="scroll-mt-20 bg-charcoal py-24 text-ivory md:py-32">
        <div className="container-x grid gap-14 md:grid-cols-12">
          <div className="md:col-span-4" data-reveal>
            ...
            <h2 className="h2 mt-4">Check a date for Town Hall.</h2>
